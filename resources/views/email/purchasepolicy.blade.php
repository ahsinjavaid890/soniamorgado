                                       ...
                                       <tbody>
                                          <tr>
                                             <td role="modules-container" style="padding:0px 0px 0px 0px;color:#67778f;text-align:left" bgcolor="#FFFFFF" width="100%" align="left">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" style="padding:0px 0px 0px 0px" bgcolor="#2B3481">
                                                   <tbody>
                                                                  ...
                                                                  <tr>
                                                                     <td style="padding:0px;margin:0px;border-spacing:0">
                                                                        <table role="module" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed">
                                                                           <tbody>
                                                                              <tr>
                                                                                 <td style="padding:18px 30px 18px 30px;line-height:22px;text-align:inherit;background-color:#2b3481" height="100%" valign="top" bgcolor="#2B3481" role="module-content">
                                                                                    <div>
                                                                                          ...
                                                                                          <tbody>
                                                                                             <tr>
                                                                                                <td height="100%" valign="top" role="module-content">
                                                                                                   <table width="100%" style="background:#edf5fc;padding:24px 15px;border:1px solid #dae5ee;border-radius:10px" cellpadding="0" cellspacing="0">
                                                                                                      <tbody>
                                                                                                         <tr>
                                                                                                            <td colspan="2" style="line-height:22px;text-align:inherit;padding-bottom:20px" height="100%" valign="top" bgcolor="">
                                                                                                               <div style="font-weight:800;color:#2b3481;font-size:20px;font-family:&quot;Open Sans&quot;,sans-serif">Manage your policy</div>
                                                                                                            </td>
                                                                                                         </tr>
                                                                                                         <tr>
                                                                                                            <td colspan="2" style="line-height:22px;text-align:inherit;padding-bottom:20px" height="100%" valign="top" bgcolor="">
               ...
               <tbody>
                  <tr>
                     <td style="padding:10px 0px 10px 0px;line-height:24px;text-align:inherit" height="100%" valign="top" bgcolor="" role="module-content">
                        <div>
                           <div style="font-family:&quot;Open Sans&quot;,sans-serif;text-align:inherit"><span style="white-space:pre-wrap;color:#2b3481;font-family:&quot;Open Sans&quot;,sans-serif;font-size:14px;font-weight:800;line-height:24px">Policy Status</span></div>
                           <div></div>
                        </div>
                     </td>
                  </tr>
            ...
            <table role="module" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed">
               <tbody>
                  <tr>
                     <td style="padding:10px 0px 10px 0px;line-height:24px;text-align:inherit" height="100%" valign="top" bgcolor="" role="module-content">
                        <div>
                           <div style="font-family:&quot;Open Sans&quot;,sans-serif;text-align:inherit"><span style="white-space:pre-wrap;color:#2b3481;font-family:&quot;Open Sans&quot;,sans-serif;font-size:14px;font-weight:800;line-height:24px">Start Date</span></div>
                           <div></div>
                        </div>
                     </td>
                  </tr>
            ...
            <table role="module" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed">
               <tbody>
                  <tr>
                     <td style="padding:10px 0px 10px 0px;line-height:24px;text-align:inherit" height="100%" valign="top" bgcolor="" role="module-content">
                        <div>
                           <div style="font-family:&quot;Open Sans&quot;,sans-serif;text-align:inherit"><span style="white-space:pre-wrap;color:#2b3481;font-family:&quot;Open Sans&quot;,sans-serif;font-size:14px;font-weight:800;line-height:24px">End Date</span></div>
                           <div></div>
                        </div>
                     </td>
                  </tr>
            ...
            <table role="module" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed">
               <tbody>
                  <tr>
                     <td style="padding:10px 0px 10px 0px;line-height:24px;text-align:inherit" height="100%" valign="top" bgcolor="" role="module-content">
                        <div>
                           <div style="font-family:&quot;Open Sans&quot;,sans-serif;text-align:inherit"><span style="white-space:pre-wrap;color:#2b3481;font-family:&quot;Open Sans&quot;,sans-serif;font-size:14px;font-weight:800;line-height:24px">Coverage Amount</span></div>
                           <div></div>
                        </div>
                     </td>
                  </tr>
                                                         ...
                                                         <td height="100%" valign="top">
                                                            <table width="100%" style="background:#f9fafc;margin-top:0px;padding:30px 30px;border:1px solid #dae5ee;border-radius:10px 10px 10px 10px" cellpadding="0" cellspacing="0">
                                                               <tbody>
                                                                  <tr>
                                                                     <td>
                                                                        <img width="65" height="65" src="https://lifeadvice.ca/public/email/icon.png" style="width:65px" class="CToWUd" data-bit="iit">
                                                                     </td>
