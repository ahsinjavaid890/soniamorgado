                                       ...
                                       <div class="row alignitembaseline">
                                          ...
                                          <div class="col-md-6 nopad">
                                             <div class="input-wrapper positionrelative">
                                                ...
                                                <input inputmode="numeric" onchange="dateofbirth(this.value)" id="dateofbirthfull" class="input dateofbirthclass1" type="text" placeholder="MM/DD/YYYY" name="years[]" data-placeholder="MM/DD/YYYY">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
